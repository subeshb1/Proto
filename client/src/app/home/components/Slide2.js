...
export default (
  <Carousel.Slide className="slide second container">
    <h1>Insurance Made Easy</h1>
    <div className="container " style={{ flexDirection: "row", marginTop: 50 }}>
      <div className="circle-container">
        ...
        <div className="detail">Compare Plans</div>
      </div>
      <div className="circle-container">
        <div className="circle">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="detail">24/7 Service</div>
      </div>
      <div className="circle-container">
        <div className="circle">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="detail">2000 People</div>
      </div>
      <div className="circle-container">
        <div className="circle">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="detail">Best Financial</div>
      </div>
      <div className="circle-container">
        <div className="circle">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="detail">Over 10 Crore</div>
      </div>
    </div>
  </Carousel.Slide>
);
